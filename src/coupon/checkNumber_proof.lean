...
-- the legit way to do proof is to declare it as theeorem, not def 
-- but if we want the C code, we need to use def to export 
...
-- this is the right way to do theorem in lean 
