...
#define assert(expr)                                                   \
        {                                                              \
                if (LEAN_UNLIKELY(!(expr)))                            \
                        lean_notify_assert(__FILE__, __LINE__, #expr); \
        }
#endif
#endif
...
#define LEAN_impl_CASSERT_LINE(predicate, line, file) \
        ...
        *(size_t *)mem = sz;
        ...
        static inline void LEAN_ALWAYS_INLINE lean_inc(lean_object *o)
        {
                if (!lean_is_scalar(o))
                        lean_inc_ref(o);
        }
        ...
        static inline void LEAN_ALWAYS_INLINE lean_dec(lean_object *o)
        {
                if (!lean_is_scalar(o))
                        lean_dec_ref(o);
        }
        ...
        static inline lean_ctor_object *lean_to_ctor(lean_object *o)
        {
                assert(lean_is_ctor(o));
                return (lean_ctor_object *)(o);
        }
        static inline lean_closure_object *lean_to_closure(lean_object *o)
        {
                assert(lean_is_closure(o));
                return (lean_closure_object *)(o);
        }
        static inline lean_array_object *lean_to_array(lean_object *o)
        {
                assert(lean_is_array(o));
                return (lean_array_object *)(o);
        }
        ...
        static inline lean_string_object *lean_to_string(lean_object *o)
        {
                assert(lean_is_string(o));
                return (lean_string_object *)(o);
        }
        static inline lean_thunk_object *lean_to_thunk(lean_object *o)
        {
                assert(lean_is_thunk(o));
                return (lean_thunk_object *)(o);
        }
        static inline lean_task_object *lean_to_task(lean_object *o)
        {
                assert(lean_is_task(o));
                return (lean_task_object *)(o);
        }
        static inline lean_promise_object *lean_to_promise(lean_object *o)
        {
                assert(lean_is_promise(o));
                return (lean_promise_object *)(o);
        }
        static inline lean_ref_object *lean_to_ref(lean_object *o)
        {
                assert(lean_is_ref(o));
                return (lean_ref_object *)(o);
        }
        static inline lean_external_object *lean_to_external(lean_object *o)
        {
...
#define LEAN_MIN_SMALL_INT (sizeof(void *) == 8 ? INT_MIN : (INT_MIN >> 1))
        ...
        */
        ...
        static inline uint8_t lean_uint8_of_nat_mk(lean_obj_arg a)
        {
                uint8_t r = lean_uint8_of_nat(a);
                lean_dec(a);
                return r;
        }
        ...
        static inline uint16_t lean_uint16_of_nat_mk(lean_obj_arg a)
        {
                uint16_t r = lean_uint16_of_nat(a);
                lean_dec(a);
                return r;
        }
        ...
        static inline uint32_t lean_uint32_of_nat_mk(lean_obj_arg a)
        {
                uint32_t r = lean_uint32_of_nat(a);
                lean_dec(a);
                return r;
        }
        ...
        static inline uint64_t lean_uint64_of_nat_mk(lean_obj_arg a)
        {
                uint64_t r = lean_uint64_of_nat(a);
                lean_dec(a);
                return r;
        }
        ...
        static inline size_t lean_usize_of_nat_mk(lean_obj_arg a)
        {
                size_t r = lean_usize_of_nat(a);
                lean_dec(a);
                return r;
        }
        ...
        static inline b_lean_obj_res lean_io_result_get_value(b_lean_obj_arg r)
        {
                assert(lean_io_result_is_ok(r));
                return lean_ctor_get(r, 0);
        }
        static inline b_lean_obj_res lean_io_result_get_error(b_lean_obj_arg r)
        {
        ...
        {
                int8_t result;
                if (lean_float_isnan(a))
                        result = 0;
                else
                        result = -129. < a ? (a < 128. ? (int8_t)a : INT8_MAX) : INT8_MIN;
        ...
        static inline uint16_t lean_float_to_int16(double a)
        {
                ...
                if (lean_float_isnan(a))
                        ...
                        result = -32769. < a ? (a < 32768. ? (int16_t)a : INT16_MAX) : INT16_MIN;
        ...
        static inline uint32_t lean_float_to_int32(double a)
        {
                ...
                if (lean_float_isnan(a))
                        ...
                        result = -2147483649. < a ? (a < 2147483648. ? (int32_t)a : INT32_MAX) : INT32_MIN;
        ...
        static inline uint64_t lean_float_to_int64(double a)
        {
                ...
                if (lean_float_isnan(a))
                        ...
                        result = -9223372036854775809. < a ? (a < 9223372036854775808. ? (int64_t)a : INT64_MAX) : INT64_MIN;
        ...
        static inline size_t lean_float_to_isize(double a)
        {
                if (sizeof(size_t) == sizeof(uint64_t))
                {
                        ...
                        if (lean_float_isnan(a))
                                ...
                                result = -9223372036854775809. < a ? (a < 9223372036854775808. ? (ptrdiff_t)a : INT64_MAX) : INT64_MIN;
                ...
                else
                {
                        ...
                        if (lean_float_isnan(a))
                                ...
                                result = -2147483649. < a ? (a < 2147483648. ? (ptrdiff_t)a : INT32_MAX) : INT32_MIN;
                        return (size_t)result;
                }
        }
