(module $user.wasm
  ...
  (func $_start (type 7)
    ...
    unreachable)
  (func $l_checkNumber (type 3) (param i32) (result i32)
    local.get 0
    i32.const 42
    i32.eq)
          ...
          block  ;; label = @4
            block  ;; label = @5
              ...
              block  ;; label = @6
                ...
                i32.add
                i32.const 0
                i64.load offset=4176 align=4
                i64.store align=4
                local.get 9
                i32.const 0
                i64.load offset=4168 align=4
